export default {
  ...
  cssSelector: "#vfc-services-article",
  name: "Services article",
  style: {
    "article": {
      "--header-bg": "#7196a8",
      "--section-gap": "80px",
  ...
  render: ({env, header, requestServiceLabel, callUsLabel, phone, section1, section2, section3}) => {
    ...
    return `
      <article>
        ...
        <main class="wrapper">
         <section>
          ${section1}
          <a href="/referrals" class="btn">${requestServiceLabel}</a>
         </section>
         <section>
          ${section2}
         </section>
         <section>
          ${section3}
          <a href="tel:${phoneNumber}" class="call-us-btn">${callUsLabel}: ${phone}</a>
         </section>
