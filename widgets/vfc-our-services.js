export default {
  ...
  inputs: [
    ...
    },
    {
      type: "image",
      name: "thumbnail",
      value: "assets/vfc-healthcare-solutions-service.webp"
    },
  ],
  render: ({env, services, action, thumbnail, header}) => {
    return `
      <section class="wrapper">
       ...
       <div class="content">
        ...
        <img src="${env.assetsOrigin || '/'}${thumbnail}" alt="VFC healthcare solutions services" loading="lazy">
       </div>
      </section>
    `
  }
